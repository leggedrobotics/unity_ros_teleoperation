    ...
    internal sealed class Dithering
    {
        ...
        internal void Render(PostProcessRenderContext context)
        {
            ...
            try {
                ...
                if (e is ArgumentNullException or MissingReferenceException) {
                    //WARNING: Unity's code is broken. Also would be annoying to get spammed from these errors.
                    //  noiseTex = null and blueNoise64 doesn't exist anymore. No idea what this is about
                    //  (tested on Unity 2021.3.30)
                    // Debug.LogWarning("Internal Unity post-processing error: " + e.GetType().Name + ":\n\n" + e.Message);
                } else throw;
            }
        }
    }
